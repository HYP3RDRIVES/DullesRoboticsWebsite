...
(function() {
  ...
  /* ----------------------------------------------- 
  */
  var clamp, hexToRgb, isInArray, pJS;
  ...
  pJS = function(tag_id, params) {
    ...
    pJS.fn.particle = function(color, opacity, position) {
      ...
      var color_selected, sh, shape_selected, shape_type, velbase;
      /* size */
    ...
    pJS.fn.particle.prototype.draw = function() {
      ...
      var color_value;
      var img_obj;
      var color_value, draw, img_obj, opacity, p, radius;
      p = this;
      draw = function() {
    ...
    pJS.fn.interact.linkParticles = function(p1, p2) {
      /* style */
      var color_line, dist, dx, dy, opacity_line;
      dx = p1.x - p2.x;
      dy = p1.y - p2.y;
    ...
    pJS.fn.modes.bubbleParticle = function(p) {
      ...
      var dist_mouse;
      /* on hover event */
      var dif, dist_mouse, dx_mouse, dy_mouse, init, opacity, process, ratio, size, time_spent;
      init = function() {
    ...
    pJS.fn.modes.repulseParticle = function(p) {
      var repulseRadius;
      var d, dist_mouse, dx, dx_mouse, dy, dy_mouse, force, normVec, pos, process, repulseFactor, repulseRadius, velocity;
      process = function() {
        var f, pos;
        f = Math.atan2(dy, dx);
    ...
    pJS.fn.modes.grabParticle = function(p) {
      /* style */
      var color_line, dist_mouse, dx_mouse, dy_mouse, opacity_line;
    ...
    pJS.fn.vendors.densityAutoParticles = function() {
      ...
      var area, missing_particles, nb_particles;
    ...
    pJS.fn.vendors.createSvgImg = function(p) {
      ...
      var DOMURL, coloredSvgXml, img, rgbHex, svg, svgXml, url;
    ...
    pJS.fn.vendors.drawShape = function(c, startX, startY, sideLength, sideCountNumerator, sideCountDenominator) {
      var decimalSides, i, interiorAngle, interiorAngleDegrees, sideCount;
  ...
  window.particlesJS = function(tag_id, params) {
    ...
    /* pJS elements */
    var canvas, canvas_el, exist_canvas, pJS_canvas_class, pJS_tag;
    //console.log(params);
