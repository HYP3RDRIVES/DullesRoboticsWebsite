...
<body style="">
  ...
  <div class="container" style="height:100%;">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <p class="lead-text text-justify lead" style="text-align:center;text-align:center;">The build team is charge of the building of our robots, both for FTC and FRC. They work against deadlines to ensure that the robot is ready for debugging,
            while also remaining in close communication with the Programming and Design teams to ensure the robot functions correctly and meets the original concept.</p>
        </div>
        <div class="col">
          ...
          <p class="lead-text text-justify lead" style="text-justify:auto;text-align:center;">The programming team is in charge of programming the instructions for what the robot is supposed to do. This includes programming the robot to respond with
            the intended results using a controller, as well as writing code for the robot to perform autonomously. The programmers here at Dulles Robotics use Java.</p>
        </div>
        <div class="col">
      ...
      <div class="row">
        <div class="col">
          ...
          <p class="lead-text text-justify lead" style="text-justify:auto;text-align:center;">Presentation is responsible for the image of Dulles Robotics. They make the PIT displays, and other brand releated content including Graphics Design, and
            Maintaining this Website.</p>
        </div>
        <div class="col">
    ...
    <div class="row" style="padding-top:10px; margin-left:0%;">
      <h1 class="display-6">The website</h1>
      <hr>
    </div>
    <div class="lead">
      <p>Dullesrobotics.com is self-hosted at home, by a few of our members. Originally starting off as a site on weebly, we were able to accuire a domain, and eventually our own servers. In the summer of 2019, the site recived a major overhaul,
        after transitioning to PHP, and Bootstrap. Special thanks to <strong>Geoffrey Dolive</strong> for helping fund our domain for 2019-2020!</p>
    </div>
