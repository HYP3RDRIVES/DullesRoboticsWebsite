...
-->
            <div class="scard">
            <p class="lead text-justify" color="black"> <strong> The Story of the Club, written by Karim Karim - Co-Founder and Former Club President.</strong> </p>
            </div>
            ...
            <div class="scard" style="display:inline-block; width:2000px;">
...
<div class="scard" style="display:inline-block">
