<!--
	Dulles High School Robotics Club 2018-2020
        ...
        <div class="col-md-2" style=" padding: 30px;">
          ...
          <div class="scard" style="width:900px;height:300px;">
            <p class="lead text-justify">The first ever official year of Robotics was when I was in 8th grade. There was a guy named Vishnu Iyer, and at this time he'd have been a junior at Dulles. He started "Robotics", and you'll see why I put this
              ...
              I entered Dulles and Vishnu became a Senior, I met him on facebook because I was looking for Robotics and he was the person that kept showing up. I asked him to teach me how electronics work and how to use hardware (I only knew how to
              do software up until this point). He spent a lot of time teaching me and convinced me to buy like $200-$300 worth of components (capacitors, resistors, transistors, etc).
            </p>
          </div>
        </div>
        <div class="col" style=" padding: 30px;">
          <div class="scard" style="width:900px;height:300px;">
            ...
            <p class="lead text-justify">
              ...
              in and Vishnu was standing at the front with Shreyas (he goes to MIT now) and there wera a bunch of other REALLY smart, and talented people. The first meeting was the Interest<br /> meeting and they were talking about how the club is
              gonna be focused around using Arduino and having small contests within the club. At that point FTC and FRC wasn't even in the air at this point nor was it in anyone's mind.
            </p>
          </div>
        </div>
        <div class="col" style=" padding: 30px;">
          <div class="scard" style="width:900px;height:300px;">
            <p class="lead text-justify">
              ...
              meeting I remember Vishnu taught us to use an LED and make it blink and then gave us a "homework" lesson to code a weird LED thingy, but we never had another meeting after that.
            </p>
          </div>
        </div>
        <div class="col" style=" padding: 30px;">
          <div class="scard" style="width:900px;height:300px;">
            <p class="lead text-justify">
              ...
              Mrs.Nguyen's room. I remember as we were planning the interest meeting, we kept moving the date further and further since Mrs.Nguyen was busy.
            </p>
          </div>
        </div>
        <div class="col" style=" padding: 30px;">
